...
@section('breadcrumb', 'Tambah anggota tim sales')
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required
                        class="form-input" placeholder="Andi Prasetyo">
                </div>

                <div>
                    <label class="form-label">Email <span class="text-red-500">*</span></label>
                    <input type="email" name="email" value="{{ old('email') }}" required
                        class="form-input" placeholder="andi@perusahaan.com">
                </div>
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400 mt-1">Sales: akses lapangan. Admin: kelola data & laporan.</p>
                </div>
